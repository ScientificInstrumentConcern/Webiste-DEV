...
function Hero() {
    ...
    return <div>
        ...
        <div className={classes.section}>
           ...
           <a href='https://firebasestorage.googleapis.com/v0/b/tutorial-8017f.appspot.com/o/Final%20Catalogue%20SINCON-compressed.pdf?alt=media&token=1dd52908-bea5-4783-bdd0-4c58a8d52533' target='blank'> <Typography align='center'><Button variant="outlined" color='primary' className={classes.btn}> View Catalouge </Button></Typography> </a>
        </div>
        </div>
</div>;
}
